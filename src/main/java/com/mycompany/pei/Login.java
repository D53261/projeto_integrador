...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 620, 70, 20));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Rectangulo1.png"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Imagem_de_fundo.png"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -50, 430, 910));
    ...
    // Cria um objeto Confirma com o email e senha
    Confirma confirma = new Confirma();
    confirma.setEmail(email);
    confirma.setSenha(senha);
    
    // Cria uma instância do DAO para autenticação
